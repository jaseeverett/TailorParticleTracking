...
full_data_endpoints <- subset(full_data_endpoints, Spawning_Event == "Summer NSW")
...
ggsave(filename = "Output/Faceted_distribution_Annual Variation_Summer_NSW_Final.pdf", width = 21, height = 29.7, units = "cm")
ggsave(filename = "Output/Faceted_distribution_Annual Variation_Summer_NSW_Final.png", width = 21, height = 29.7, units = "cm", dpi = 600)
