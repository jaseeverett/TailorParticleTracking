...
full_data_endpoints <- subset(full_data_endpoints, Spawning_Event == "Spring QLD")
...
dots <- read.csv("forward_release_summary _table_QLD.csv", header = T)
...
ggsave(filename = "Output/Faceted_distribution_Annual Variation_Spring_QLD_Final.pdf", width = 21, height = 29.7, units = "cm")
ggsave(filename = "Output/Faceted_distribution_Annual Variation_Spring_QLD_Final.png", width = 21, height = 29.7, units = "cm", dpi = 600)
