# Script to take each file and subset it down to just endpoints or endpoints on the shelf.
...
file_names <- list.files("../../srv/scratch/z3374139/Forward_with_Mortality/", pattern=".rds")
file_names2 <- paste("../../srv/scratch/z3374139/Forward_with_Mortality/", file_names, sep="")

save_names <- file_path_sans_ext(file_names)
save_names2 <- paste0("../../srv/scratch/z3374139/Forward_with_Mortality_endpoints/", save_names, sep="")
...
saveRDS(mydata3, file = paste(save_names2[ID], "_endpoints_shelf.rds", sep=""))
